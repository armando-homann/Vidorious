	...
	(function() {
		var target = $('#gaugeBasic'),
			opts = $.extend(true, {}, {
				...
				colorStart: '#D95B28', // Colors
				colorStop: '#D95B28', // just experiment with them
